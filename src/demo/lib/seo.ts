...
export const DEMO_FAQ_ITEMS = [
  {
    ...
    answer:
      "DaalCRM، محصول گروه فناوری دال (daalgp.com)، یک سامانه مدیریت ارتباط با مشتری فارسی برای ثبت سرنخ، مدیریت مخاطب و شرکت، پیگیری فروش، مدیریت معاملات، پیش‌فاکتور، پرداخت و گزارش‌گیری است.",
  },
  {
  ...
  {
    question: "DaalCRM به حسابفا و زرین‌پال وصل می‌شود؟",
    answer:
      "بله. از صفحه یکپارچه‌سازی‌ها می‌توانید حسابفا را برای همگام‌سازی مخاطبان تنظیم کنید و از روی فاکتورهای CRM لینک پرداخت زرین‌پال بسازید. نتیجه پرداخت پس از تأیید درگاه در سوابق پرداخت ثبت می‌شود.",
  },
  {
    question: "هزینه راه‌اندازی دال چطور محاسبه می‌شود؟",
    answer:
      "راه‌اندازی اولیه پس از خرید دال رایگان است. هزینه خرید بر اساس تعداد کاربران، امکانات موردنیاز و مسیر استقرار مشخص می‌شود؛ مهاجرت داده، اتصال‌های ویژه و توسعه اختصاصی در صورت نیاز جداگانه بررسی می‌شوند.",
  },
  {
...
export function getDemoStructuredData(pathname = "/demo") {
  ...
  return {
    ...
    "@graph": [
      ...
      },
      {
        ...
        inLanguage: "fa-IR",
        description:
          "سامانه مدیریت ارتباط با مشتری فارسی برای مدیریت سرنخ، قیف فروش، پیگیری، اتوماسیون، فاکتور، پرداخت و اتصال به حسابفا و زرین‌پال.",
        featureList: [
          ...
          "اتصال حسابداری حسابفا و درگاه پرداخت زرین‌پال",
