...
export const DEMO_FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer:
      "دال با سه پلن ماهانه و یک گزینهٔ خرید دائمی ارائه می‌شود: پلن شروع برای ۵ کاربر ۳٫۵۵۶۸ میلیون تومان در ماه است و پلن رشد برای تیم‌های ۵ تا ۵۰ نفر با تعداد کاربران انتخابی محاسبه می‌شود. برای تیم‌های بزرگ‌تر، قیمت‌گذاری سازمانی انجام می‌شود و لایسنس دائمی ۲۴۹ میلیون تومان است. نصب اولیه طبق فرایند استاندارد انجام می‌شود؛ خرید دائمی سه ماه پشتیبانی دارد و اتصال‌های ویژه یا توسعه اختصاصی جداگانه برآورد می‌شوند.",
  },
  {
