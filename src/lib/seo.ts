...
export const DEMO_FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer:
      "دال با سه پلن ماهانه و یک گزینهٔ خرید دائمی ارائه می‌شود: پلن شروع تا ۵ کاربر ماهانه ۲٫۹۶۴ میلیون تومان، پلن رشد تا ۱۵ کاربر ماهانه ۶٫۷۸۶ میلیون تومان، پلن سازمانی با قیمت‌گذاری سفارشی و لایسنس دائمی ۲۰۰ میلیون تومان. نصب اولیه طبق فرایند استاندارد انجام می‌شود؛ خرید دائمی سه ماه پشتیبانی دارد و اتصال‌های ویژه یا توسعه اختصاصی جداگانه برآورد می‌شوند.",
  },
  {
