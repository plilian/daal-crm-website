...
export const DEMO_FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer:
      "قیمت شروع دال از ۲۹۹ هزار تومان به‌ازای هر کاربر فعال در ماه است. پلن رشد ۳۹۹ هزار تومان و پلن سازمانی از ۶۹۹ هزار تومان برای هر کاربر در ماه محاسبه می‌شود؛ پرداخت سالانه شامل دو ماه رایگان است.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "راه‌اندازی اولیه پس از خرید دال رایگان است. قیمت اشتراک از ۲۹۹ هزار تومان به‌ازای هر کاربر در ماه شروع می‌شود و مهاجرت داده، اتصال‌های ویژه و توسعه اختصاصی در صورت نیاز جداگانه بررسی می‌شوند.",
  },
  {
