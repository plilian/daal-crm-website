...
export const DEMO_FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer:
      "دال با لایسنس ماهانه و بر اساس ظرفیت تیم ارائه می‌شود: پلن شروع تا ۵ کاربر ماهانه ۱٫۹ میلیون تومان، پلن رشد تا ۱۵ کاربر ماهانه ۳٫۹ میلیون تومان و پلن سازمانی از ۸٫۹ میلیون تومان در ماه شروع می‌شود. نصب اولیه طبق فرایند استاندارد انجام می‌شود؛ پشتیبانی در پلن رشد و سازمانی ارائه می‌شود و اتصال‌های ویژه یا توسعه اختصاصی جداگانه برآورد می‌شوند.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "نصب و تنظیمات اولیه پس از شروع لایسنس ماهانه و طبق فرایند استاندارد بدون هزینه جداگانه انجام می‌شود. مهاجرت داده، اتصال‌های ویژه و توسعه اختصاصی، در صورت نیاز، جداگانه بررسی و برآورد می‌شوند.",
  },
  {
    question: "آیا تمدید لایسنس دال لازم است؟",
    answer:
      "بله. دال با لایسنس ماهانه ارائه می‌شود و برای ادامه استفاده از نرم‌افزار، پرداخت باید هر ماه تمدید شود. در صورت توقف پرداخت، حق استفاده از نرم‌افزار ادامه پیدا نمی‌کند؛ داده‌ها روی سرور سازمان شما باقی می‌مانند.",
  },
  {
