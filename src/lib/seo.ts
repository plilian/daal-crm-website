...
export const DEMO_FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer:
      "بله. دال Cloud نیست و روی سرور سازمان شما نصب می‌شود تا داده‌ها در زیرساخت خودتان بماند. نصب و تنظیمات اولیه پس از خرید لایسنس، بدون هزینه جداگانه انجام می‌شود.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "بله. دال برای اتصال پیامک، ایمیل SMTP، تلفن Asterisk یا Issabel، PostgreSQL، OpenAI، Gemini و سرویس‌های سازگار با OpenAI یا هوش مصنوعی محلی آماده شده است.",
  },
  {
