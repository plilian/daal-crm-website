...
export const DEMO_FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer:
      "دال با سه پلن ماهانه و یک گزینهٔ خرید دائمی ارائه می‌شود: پلن شروع برای حداقل ۵ کاربر از ۳٫۵۵۶۸ میلیون تومان در ماه محاسبه می‌شود و پلن رشد در مرجع ۱۵ کاربر ۱۰٫۸۵۷۶ میلیون تومان است. تعداد کاربران را در صفحهٔ قیمت‌گذاری وارد کنید تا مبلغ ماهانه محاسبه شود؛ پلن سازمانی قیمت‌گذاری سفارشی دارد و لایسنس دائمی ۲۴۹ میلیون تومان است. نصب اولیه طبق فرایند استاندارد انجام می‌شود؛ خرید دائمی سه ماه پشتیبانی دارد و اتصال‌های ویژه یا توسعه اختصاصی جداگانه برآورد می‌شوند.",
  },
  {
