...
export const DEMO_FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer:
      "دال با دو پلن ماهانه و یک گزینهٔ خرید دائمی ارائه می‌شود: پلن‌های شروع و رشد برای تیم‌های ۵ تا ۵۰ نفر با تعداد کاربران انتخابی محاسبه می‌شوند و قیمت پایهٔ آن‌ها به‌ترتیب از ۳٫۵۵۶۸ و ۴٫۷۰۴۹۶ میلیون تومان در ماه آغاز می‌شود. برای تیم‌های بزرگ‌تر، قیمت‌گذاری سازمانی انجام می‌شود و لایسنس دائمی ۲۴۹ میلیون تومان برای ۲۰ کاربر است. نصب اولیه طبق فرایند استاندارد انجام می‌شود؛ خرید دائمی سه ماه پشتیبانی دارد و اتصال‌های ویژه یا توسعه اختصاصی جداگانه برآورد می‌شوند.",
  },
  {
