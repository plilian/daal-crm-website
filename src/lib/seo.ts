...
export const DEMO_FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer:
      "در دموی عمومی می‌توانید مسیر نمونه‌ی فروش را از ورود سرنخ تا معامله، پیگیری، پیش‌فاکتور، پرداخت، گزارش و اتصال‌های پیامک، ایمیل، تلفن و هوش مصنوعی ببینید.",
  },
  {
    question: "آیا استفاده از دموی عمومی هزینه دارد؟",
    answer:
      "خیر. دموی عمومی برای آشنایی با امکانات دال رایگان است و بدون ورود اجرا می‌شود؛ برای استفاده عملی از سامانه، خرید و راه‌اندازی لازم است.",
  },
  {
