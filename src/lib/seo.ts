...
export const DEMO_FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer:
      "دال با دو پلن ماهانه و یک گزینهٔ خرید دائمی ارائه می‌شود: پلن‌های شروع و رشد برای تیم‌های ۵ تا ۵۰ نفر با تعداد کاربران انتخابی محاسبه می‌شوند و قیمت هر کاربر به‌ترتیب ۷۲۰ هزار و ۱ میلیون و ۱۰۰ هزار تومان در ماه است. برای تیم‌های بزرگ‌تر، قیمت‌گذاری سازمانی انجام می‌شود و لایسنس دائمی ۲۴۹ میلیون تومان برای ۲۰ کاربر است. مشخصات سرور مناسب را اعلام می‌کنیم و نصب و راه‌اندازی استاندارد روی سرور شما کاملاً رایگان است؛ انتقال داده‌های قبلی، اتصال‌های ویژه و توسعه اختصاصی جداگانه بررسی و برآورد می‌شوند.",
  },
  {
    question: "خرید دائمی دال شامل چه چیزهایی است؟",
    answer:
      "با پرداخت یک‌بارهٔ ۲۴۹ میلیون تومان، لایسنس دائمی ۲۰ کاربرهٔ نسخهٔ خریداری‌شده را دریافت می‌کنید و برای ادامهٔ استفاده نیاز به تمدید ماهانه ندارید. نصب و راه‌اندازی اولیه انجام می‌شود و سه ماه پشتیبانی پس از خرید و استقرار در نظر گرفته شده است؛ تمدید پشتیبانی بعد از این دوره اختیاری و جداگانه است.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "بله. دال روی سرور سازمان شما نصب می‌شود تا اطلاعات در زیرساخت خودتان بماند. بر اساس تعداد کاربران و اتصال‌های موردنیاز، مشخصات سرور مناسب را اعلام می‌کنیم و پس از آماده‌شدن سرور، نصب و راه‌اندازی استاندارد را کاملاً رایگان انجام می‌دهیم.",
  },
  {
    question: "هزینه راه‌اندازی و استقرار چطور محاسبه می‌شود؟",
    answer:
      "نصب و راه‌اندازی استاندارد پس از خرید لایسنس ماهانه یا دائمی و آماده‌شدن سرور، کاملاً رایگان انجام می‌شود. انتقال داده‌های قبلی، پاک‌سازی یا تبدیل اطلاعات، اتصال‌های ویژه و توسعه اختصاصی، در صورت نیاز، جداگانه بررسی و برآورد می‌شوند.",
  },
  {
