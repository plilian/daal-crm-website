...
export const DEMO_FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer:
      "دال با سه پلن ماهانه و یک گزینهٔ خرید دائمی ارائه می‌شود: پلن شروع تا ۵ کاربر ماهانه ۲٫۲۸ میلیون تومان، پلن رشد تا ۱۵ کاربر ماهانه ۴٫۶۸ میلیون تومان، پلن سازمانی از ۱۰٫۶۸ میلیون تومان در ماه و لایسنس دائمی ۲۰۰ میلیون تومان. نصب اولیه طبق فرایند استاندارد انجام می‌شود؛ خرید دائمی سه ماه پشتیبانی دارد و اتصال‌های ویژه یا توسعه اختصاصی جداگانه برآورد می‌شوند.",
  },
  {
    question: "خرید دائمی دال شامل چه چیزهایی است؟",
    answer:
      "با پرداخت یک‌بارهٔ ۲۰۰ میلیون تومان، لایسنس دائمی نسخهٔ خریداری‌شده را دریافت می‌کنید و برای ادامهٔ استفاده نیاز به تمدید ماهانه ندارید. نصب و راه‌اندازی اولیه انجام می‌شود و سه ماه پشتیبانی پس از خرید و استقرار در نظر گرفته شده است؛ تمدید پشتیبانی بعد از این دوره اختیاری و جداگانه است.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "در پلن‌های ماهانه بله؛ برای ادامهٔ استفاده از نرم‌افزار، پرداخت باید هر ماه تمدید شود و با توقف پرداخت حق استفاده ادامه پیدا نمی‌کند. اما لایسنس دائمی ۲۰۰ میلیون تومانی نیاز به تمدید لایسنس ندارد و سه ماه پشتیبانی اولیه را شامل می‌شود؛ داده‌ها در هر دو مدل روی سرور سازمان شما باقی می‌مانند.",
  },
  {
